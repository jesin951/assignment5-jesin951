...
## Part I
```{r}
D1 <- read.csv("D:/HUDK 4050 Core Mthds Educ Data Mining_Lang/assignments/assignment5-jesin951/intelligent_tutor.csv", header=T) 
```
...
Answer: The teacher should most closely pay attention to prior_prob_count and prior_percent_correct since they can classify the largest number of students.
...
```{r}
#Upload new data
D2 <- read.csv("D:/HUDK 4050 Core Mthds Educ Data Mining_Lang/assignments/assignment5-jesin951/intelligent_tutor_new.csv", header=T)
